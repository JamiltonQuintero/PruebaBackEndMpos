...
Prueba BackEnd desarrollada en java en la versión 8 y springboot en su version 2.1.3 con sts(spring tool suite)
...
Para ejecutar el proyecto sin inconvenientes debes realizar los siguientes pasos:
...
3 - Si no tienes habilitado el puerto 1433 por favor sigue estos pasos:
```sh
