...
public class ProductCategoryRestController {
    ...
    @PostMapping(path = "/saveUpdateProductCategory")
    public ResponseEntity<?> saveUpdateProductCategory(@RequestBody(required = true) ProductCategoryPostTO productCategoryPostTO) {
    	try {
    		
    		productCategoryService.saveUpdateProductCategory(productCategoryPostTO);
